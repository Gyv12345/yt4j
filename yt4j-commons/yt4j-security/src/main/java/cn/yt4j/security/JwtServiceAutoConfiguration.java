...
import cn.yt4j.security.config.MedicalSecurityConfig;
...
@ConditionalOnClass({UserDetailsService.class, MedicalSecurityConfig.class,  JwtAuthenticationTokenFilter.class, JwtUtil.class})
