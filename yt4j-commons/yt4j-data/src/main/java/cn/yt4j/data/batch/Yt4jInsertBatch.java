...
/**
 * 用于mysql的批量添加，现在仅支持无主键生成策略
 * 但是还是判断了一下主键生成策略，应该说，如果主键上有自增类型，那么sql就没有主键字段了
 * 主要还是构建语句
...
public class Yt4jInsertBatch extends AbstractMethod {
    ...
    public MappedStatement injectMappedStatement(Class<?> mapperClass, Class<?> modelClass, TableInfo tableInfo) {
        ...
        return this.addInsertMappedStatement(mapperClass, modelClass, "batchInsertByMysql", sqlSource, new NoKeyGenerator(), null, null);
    }
