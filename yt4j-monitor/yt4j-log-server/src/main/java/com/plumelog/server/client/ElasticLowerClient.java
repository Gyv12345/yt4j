...
/**
 * className：ElasticLowerClient description：ElasticLowerClient
 *
 * @author Frank.chen
 * @version 1.0.0
 */
	...
	public boolean creatIndice(String indice, String type) {
		...
		try {
			...
			String properties = "\"properties\":{\"appName\":{\"type\":\"keyword\"},"
					+ "\"logLevel\":{\"type\":\"keyword\"}," + "\"serverName\":{\"type\":\"keyword\"},"
			...
			String ent = "{\"settings\":{\"number_of_shards\":" + InitConfig.ES_INDEX_SHARDS
					+ ",\"number_of_replicas\":" + InitConfig.ES_INDEX_REPLICAS + ",\"refresh_interval\":\""
					+ InitConfig.ES_REFRESH_INTERVAL + "\"}";
