...
/**
 * className：GfJsonUtil description：fastjson封装类
 *
 * @author Frank.chen
 * @version 1.0.0
 */
public abstract class GfJsonUtil {
	...
	public static <T> Map<Long, T> parseMapByUid(List<String> jsonList, List<Long> uidList, Class<T> clazz,
	...
	public static <T> Map<Long, List<T>> parseArrayMapByUid(List<String> jsonList, List<Long> uidList, Class<T> clazz,
			boolean isContainsNull) {
		if (jsonList.size() != uidList.size()) {
			return null;
		}
