...
/**
 * className：RedisLogCollect description：RedisLogCollect 获取redis中日志，存储到es
 *
 * @author Frank.chen
 * @version 1.0.0
 */
public class RedisLogCollect extends BaseLogCollect {
	...
	public RedisLogCollect(ElasticLowerClient elasticLowerClient, RedisClient redisClient,
