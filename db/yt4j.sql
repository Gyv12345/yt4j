...
INSERT INTO `sys_dept` VALUES (4, 1, '郑州分部', 3, NULL, '2020-09-06 11:13:48', '2021-02-09 15:18:22');
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, 1, 0, 'System', '基础系统', 'sys_system', 'heat-map', '[0]', 1, 1, '/dashboard/workplace', '/', 'RouteView', 1, '2020-08-11 13:43:54', '2021-02-09 15:15:01');
INSERT INTO `sys_menu` VALUES (2, 1, 0, 'dashboard', '仪表盘', 'dashboard', NULL, '[0]', 1, 1, '/dashboard/workplace', '', 'RouteView', 1, '2020-08-14 15:39:33', '2021-02-09 15:14:58');
INSERT INTO `sys_menu` VALUES (3, 2, 2, 'workplace', '工作台', 'workplace', NULL, '[0],[2]', 1, 1, NULL, NULL, 'Workplace', 1, '2020-08-14 15:42:57', '2021-02-09 15:14:56');
INSERT INTO `sys_menu` VALUES (4, 2, 2, 'Analysis', '分析页', 'Analysis', NULL, '[0],[2]', 1, 1, NULL, 'dashboard/analysis', 'Analysis', 1, '2020-08-14 15:44:55', '2021-02-09 15:14:54');
INSERT INTO `sys_menu` VALUES (5, 2, 2, 'table-list', '表格', 'table', NULL, '[0],[2]', 1, 1, NULL, '/list/table-list', 'TableList', 1, '2020-08-17 09:35:53', '2021-02-09 15:14:53');
INSERT INTO `sys_menu` VALUES (6, 2, 1, 'sys_user', '用户管理', 'sys_user', 'copy', '[0],[1]', 1, 1, NULL, '/sys-user/list', 'sys/user/index', 1, '2020-08-17 15:05:11', '2021-02-09 15:14:52');
INSERT INTO `sys_menu` VALUES (7, 2, 1, 'sys_menu', '菜单管理', 'sys_menu', 'file-add', '[0],[1]', 1, 1, NULL, '/sys-menu/list', 'sys/menu/index', 1, '2020-08-25 15:48:04', '2021-02-09 15:14:50');
INSERT INTO `sys_menu` VALUES (8, 2, 1, 'sys_role', '角色管理', 'sys_role', 'user', '[0],[1]', 1, 1, NULL, '/sys-role/list', 'sys/role/index', 1, '2020-08-25 15:56:50', '2021-02-09 15:14:48');
INSERT INTO `sys_menu` VALUES (9, 2, 1, 'sys_dept', '部门管理', 'sys_dept', 'table', '[0],[1]', 1, 1, NULL, '/sys-dept/list', 'sys/dept/index', 1, '2020-08-25 15:58:22', '2021-02-09 15:14:46');
