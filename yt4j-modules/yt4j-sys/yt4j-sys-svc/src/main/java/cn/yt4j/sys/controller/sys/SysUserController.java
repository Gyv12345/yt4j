...
public class SysUserController {
	...
	public Result<SysUserVO> getUserByUsername(@RequestParam String username) {
		log.info("根据用户名获取用户信息");
		SysUser user = this.sysUserService.getOne(Wrappers.<SysUser>lambdaQuery().eq(SysUser::getUsername, username));
		return Result.ok(BeanUtil.copyProperties(user, SysUserVO.class));
	}
